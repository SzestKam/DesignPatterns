...
import pattern.strategy.domain.Arena;
import pattern.strategy.domain.Knight;
import pattern.strategy.domain.Weapons;
import pattern.strategy.option.ArchValidator;
import pattern.strategy.option.KnightValidator;
import pattern.strategy.option.MaleKnightsValidator;
import pattern.strategy.option.OldKnightsValidator;
